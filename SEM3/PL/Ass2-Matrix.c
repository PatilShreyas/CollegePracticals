...
void addMatricesPtr(int *, int *, int *, int, int, int, int);
...
int main()
{
	...
	do
	{
		...
		switch(choice)
		{
			...
			case 6:
				addMatricesPtr(&a[0][0],&b[0][0],&c[0][0],r1,c1,r2,c2);
				printf("\nAddition of Matrices (A+B) =\n");
				display(c,r1,c1);
...
void addMatricesPtr(int *a, int *b, int *c, int rows1, int cols1, int rows2, int cols2)
{
	int i,j;
...
student@student-OptiPlex-330:~/Desktop/Shreyas$ gcc Ass2-Matrix.c
